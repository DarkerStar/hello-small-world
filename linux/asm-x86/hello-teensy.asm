...
; The only "trick" used is that the program header is overlapped with the ELF
; header. However, it is only overlapped by 8 bytes - just as far as the
; correct values match up, with no skullduggery.
